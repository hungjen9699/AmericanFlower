...
@XmlType(name = "Flower", propOrder = { //    "flowerID",
//    "flowerCategoryID",
//    "flowerName",
//    "imgLink",
//    "season",
...
@NamedQueries({
    ...
    , @NamedQuery(name = "Flower.findByFlowerNameAndCategoryId", query = "SELECT t FROM Flower t WHERE t.flowerName = :flowerName AND t.flowerCategory.flowerCategoryID = :flowerCategoryID")
    , @NamedQuery(name = "Flower.findByCategoryName", query = "SELECT t FROM Flower t WHERE t.flowerCategory.flowerCategoryName = :flowerCategoryName")
    , @NamedQuery(name = "Flower.findByCategoryAndName", query = "SELECT t FROM Flower t WHERE t.flowerCategory.flowerCategoryName = :flowerCategoryName AND t.flowerName LIKE :flowerName")
    , @NamedQuery(name = "Flower.findFlowerByState", query = "SELECT t FROM Flower t WHERE  ((t.maturity+t.germination)<:day) and (t.flowerName LIKE :flowerName) and (t.temparature>:temparature-5) and (t.temparature<:temparature+5)")
    , @NamedQuery(name = "Flower.findByCategoryID", query = "SELECT t FROM Flower t WHERE t.flowerCategory.flowerCategoryID = :flowerCategoryID")
